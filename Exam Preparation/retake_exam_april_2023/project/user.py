class User:
    RATING_INCREASE_RATE = 0.5
    RATING_DECREASE_RATE = 2.0
    MAX_RATING = 10
    ...
    def increase_rating(self):
        self.rating += User.RATING_INCREASE_RATE
        self.rating = min(self.rating, User.MAX_RATING)

    def decrease_rating(self):
        if self.rating - User.RATING_DECREASE_RATE < 0:
            self.rating = 0
            self.is_blocked = True
        else:
            self.rating -= User.RATING_DECREASE_RATE
